import svgPaths from "./svg-wiun8pfbrl";
...
function Helpcircle() {
  return (
    <div className="relative size-[56px] pointer-events-auto" data-name="Helpcircle">
      <svg className="block size-full" viewBox="0 0 56 56" fill="none" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle cx="28" cy="28" r="28" fill="#6412b4" />
        <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fontFamily="Inter, sans-serif" fontSize="20" fill="#fff">?</text>
      </svg>
    </div>
  );
}
