import svgPaths from "./svg-nh3laldisc";
...
function Footer() {
  return (
    <div className="absolute bg-[#e7e1e6] box-border content-stretch flex flex-col h-[304px] items-start left-px pb-0 pt-[0.889px] px-[24.889px] top-[854px] w-[1356.23px]" data-name="Footer">
...
function Container5() {
  return (
    <div className="absolute h-[168px] left-[59.41px] top-[877.89px] w-[607.622px]" data-name="Container">
      <Container4 />
      <Paragraph />
    </div>
  );
...
function Heading1() {
  return (
    <div className="absolute h-[24px] left-[700px] top-[878px] w-[287.389px]" data-name="Heading 4">
...
function Container6() {
  return (
    <div className="absolute h-[84px] left-[700px] top-[918px] w-[287.389px]" data-name="Container">
      <Button />
      <Button1 />
      <Button2 />
    </div>
...
function Container7() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-start left-[700px] top-[1018px]" data-name="Container">
      <Button3 />
      <Button4 />
      <Button5 />
    </div>
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] h-[168px] items-start left-[1020.11px] top-[877.89px] w-[287.389px]" data-name="Container">
      <Heading2 />
      <Container8 />
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[55.42px] top-[877.89px]">
      <Container5 />
      <Heading1 />
      <Container6 />
      <Container7 />
      <Container9 />
      <p className="absolute font-['Poppins:Regular',sans-serif] h-[20px] leading-[20px] left-[55.42px] not-italic text-[#4a5565] text-[20px] top-[1096px] w-[798.53px]">© 2025 RouteMate. All rights reserved. Made with ❤️ for smart transportation.</p>
    </div>
  );
}
...
function Group3() {
  return (
    <div className="absolute contents left-px top-[854px]">
      <Footer />
      <Group2 />
    </div>
  );
...
function Map1() {
  return (
    <div className="absolute h-[18.514px] left-[788.66px] top-[99px] w-[19.89px]" data-name="Map">
...
function Text4() {
  return (
    <div className="absolute content-stretch flex h-[18.514px] items-start left-[815.22px] top-[98.96px] w-[81.606px]" data-name="Text">
...
function Home() {
  return (
    <div className="absolute h-[18.514px] left-[475.71px] top-[96.27px] w-[20.413px]" data-name="Home">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21 19">
        <g clipPath="url(#clip0_3_7797)" id="Home">
...
function Group() {
  return (
    <div className="absolute contents left-[475.71px] top-[96.27px]">
      <Home />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[18.514px] leading-[20px] left-[511.43px] not-italic text-[#4a5565] text-[20px] top-[96.27px] w-[58.179px]">Home</p>
    </div>
  );
}
...
function Button9() {
  return (
    <div className="absolute box-border content-stretch flex gap-[8px] h-[33.326px] items-center left-[595.22px] px-[16px] py-0 rounded-[20px] top-[90.72px] w-[125.671px]" data-name="Button">
      <Clock />
      <Text5 />
    </div>
  );
...
function Container10() {
  return (
    <div className="absolute h-[152.743px] left-[-46px] rounded-[20px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[8px] w-[194.949px]" data-name="Container">
...
function Text6() {
  return (
    <div className="absolute content-stretch flex h-[24.686px] items-start left-[118.81px] top-[59px] w-[165.35px]" data-name="Text">
...
function Button10() {
  return (
    <div className="absolute box-border content-stretch flex gap-[12px] h-[44.434px] items-center left-[1221.92px] px-[8px] py-0 rounded-[20px] top-[81px] w-[97.985px]" data-name="Button">
      <Container11 />
      <ChevronDown />
    </div>
  );
...
function Button11() {
  return <div className="absolute h-[33.517px] left-[971.49px] rounded-[20px] top-[75px] w-[150.149px]" data-name="Button" />;
}

function Group1() {
  return (
    <div className="absolute contents left-[-46px] top-[-1px]">
      <div className="absolute bg-[#e7e1e6] h-[144.411px] left-[-0.5px] top-[-1px] w-[1357.5px]" />
      <div className="absolute bg-[#e7e1e6] h-[35.177px] left-[765.28px] rounded-[50px] top-[87.02px] w-[155.143px]" />
      <Map1 />
      <Text4 />
      <Group />
      <Button9 />
      <Container10 />
      <Text6 />
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[14.811px] leading-[16px] left-[122.85px] not-italic text-[#3d3a3a] text-[25px] top-[102px] w-[198.011px]">Smart Transport</p>
      <Button10 />
      <Button11 />
    </div>
  );
...
function Clock1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_3_7769)" id="Clock">
...
function Container28() {
  return (
    <div className="bg-gradient-to-b from-[#6412b4] h-[60px] relative rounded-[20px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 to-[#2c084e] to-[72.115%] w-[64px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[60px] items-center justify-center relative w-[64px]">
        <Heart2 />
      </div>
    </div>
...
function Heading4() {
  return (
    <div className="h-[28px] relative shrink-0 w-[434px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[28px] left-[0.22px] not-italic text-[#1e2939] text-[20px] top-[-1.78px] w-[130px]">Bus 93X</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="h-[57px] relative shrink-0 w-[285px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[57px] items-start relative w-[285px]">
        <Heading4 />
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#4a5565] text-[16px] text-nowrap whitespace-pre">Tech part → Shopping centre</p>
        <Paragraph5 />
        <Paragraph6 />
      </div>
    </div>
...
function Container31() {
  return (
    <div className="content-stretch flex h-[28px] items-start relative shrink-0 w-full" data-name="Container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[28px] not-italic relative shrink-0 text-[#1e2939] text-[20px] text-nowrap text-right whitespace-pre">9:30 PM</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute bg-[#f7eeff] box-border content-stretch flex flex-col gap-[24px] h-[238px] items-start left-[674px] pb-[0.889px] pt-[24.889px] px-[24.889px] rounded-[16px] top-[306px] w-[591px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.889px] border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
      <Container33 />
      <Container34 />
    </div>
...
function Clock3() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_3_7765)" id="Clock">
          <rect fill="#300431" fillOpacity="0.92" height="16" width="16" />
          <path d={svgPaths.p39ee6532} fill="var(--fill-0, #300431)" fillOpacity="0.92" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.33333" />
          <g id="Vector_2">
            <path d="M8 4V8L10.6667 9.33333" fill="var(--fill-0, #300431)" fillOpacity="0.92" />
            <path d="M8 4V8L10.6667 9.33333" stroke="var(--stroke-0, white)" strokeWidth="1.33333" />
          </g>
        </g>
        <defs>
          <clipPath id="clip0_3_7765">
            <rect fill="white" height="16" width="16" />
          </clipPath>
        </defs>
      </svg>
...
function Button20() {
  return (
    <div className="absolute bg-[rgba(48,4,49,0.92)] content-stretch flex gap-[8px] h-[48px] items-center justify-center left-[900px] rounded-[20px] top-[465px] w-[176px]" data-name="Button">
      <Clock3 />
      <Text16 />
    </div>
  );
    ...
    <div className="absolute contents left-[-46px] top-[-1px]">
      ...
      <div className="absolute h-[44.08px] left-[966px] top-[85px] w-[157.551px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 158 45">
          <path d={svgPaths.p34a86e00} fill="url(#paint0_linear_3_7795)" id="Rectangle 42" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7795" x1="78.7757" x2="78.7757" y1="0" y2="44.08">
...
export default function Favorites() {
  return (
    <div className="relative size-full" data-name="Favorites">
      <Group4 />
    </div>
  );
}