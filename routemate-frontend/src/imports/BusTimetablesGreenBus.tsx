import svgPaths from "./svg-u5xb3x7lml";
...
function Frame() {
  return (
    <div className="absolute box-border content-stretch flex gap-[10px] items-center justify-center left-[14px] p-[10px] top-[-0.11px]">
      <p className="font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Green Bus</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="absolute bg-gradient-to-t from-[#2c084e] from-[31.749%] h-[48px] left-[233.22px] rounded-[20px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] to-[#6612b4] to-[99.537%] top-[0.22px] w-[115px]" data-name="Button">
      <Frame />
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-[rgba(74,85,101,0.54)] h-[48px] left-[109.22px] rounded-[20px] top-[0.22px] w-[105.042px]" data-name="Button">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-[24px] not-italic text-[16px] text-black text-nowrap top-[9.89px] whitespace-pre">AC Only</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="absolute h-[31.986px] left-0 top-0 w-[176.083px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[0.22px] not-italic text-[#1e2939] text-[24px] top-[-1.56px] w-[167px]">Green Bus 01</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-0 top-[31.99px] w-[176.083px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-2.11px] whitespace-pre">Numaish → University Road</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[0.22px] top-[60.44px]">
      <Text />
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="absolute h-[31.986px] left-0 top-0 w-[176.083px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[0.22px] not-italic text-[#1e2939] text-[24px] top-[-1.54px] w-[161px]">Green Bus 02</p>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="absolute h-[24px] left-0 top-[31.99px] w-[176.083px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-2.11px] whitespace-pre">Tower → Malir Cantt</p>
    </div>
  );
}
...
function Text29() {
  return (
    <div className="absolute bg-[#fbd9fa] box-border content-stretch flex h-[24px] items-start left-[0.22px] px-[12px] py-[4px] rounded-[16px] top-[64.46px] w-[101px]" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#008236] text-[14px] text-nowrap whitespace-pre">AC Express</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="absolute h-[31.986px] left-0 top-0 w-[176.083px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[0.22px] not-italic text-[#1e2939] text-[24px] top-[-1.53px] w-[170px]">Green Bus 03</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[24px] left-0 top-[31.99px] w-[176.083px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-2.11px] whitespace-pre">Main Road → Malir Halt</p>
    </div>
  );
}
...
function Text58() {
  return (
    <div className="absolute bg-[#fbd9fa] box-border content-stretch flex h-[28px] items-start left-[0.22px] px-[12px] py-[4px] rounded-[16px] top-[60.44px] w-[103px]" data-name="Text">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#008236] text-[14px] text-nowrap whitespace-pre">
        <p className="mb-0">AC Express</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
...
function Clock() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_5822)" id="Clock">
...
export default function BusTimetablesGreenBus() {
  return (
    <div className="relative size-full" data-name="Bus Timetables Green Bus">
      <Group7 />
    </div>
  );
}