import svgPaths from "./svg-4qigdrvwkt";
...
function Button() {
  return (
    <div className="absolute bg-gradient-to-t from-[#2c084e] from-[31.749%] h-[48px] left-0 rounded-[20px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] to-[#6612b4] to-[99.537%] top-0 w-[110.625px]" data-name="Button">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[24px] left-[24px] not-italic text-[16px] text-nowrap text-white top-[9.89px] whitespace-pre">All Buses</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute bg-[rgba(74,85,101,0.54)] h-[48px] left-[122.63px] rounded-[20px] top-0 w-[105.042px]" data-name="Button">
...
function Button2() {
  return (
    <div className="absolute bg-[rgba(74,85,101,0.54)] h-[48px] left-[239.67px] rounded-[20px] top-0 w-[100.361px]" data-name="Button">
...
function Heading4() {
  return (
    <div className="absolute h-[31.986px] left-0 top-0 w-[176.083px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[0.22px] not-italic text-[#1e2939] text-[24px] top-[-1.56px] w-[118px]">Bus 55</p>
    </div>
  );
}
...
function Heading5() {
  return (
    <div className="absolute h-[31.986px] left-0 top-0 w-[176.083px]" data-name="Heading 3">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-[0.22px] not-italic text-[#1e2939] text-[24px] top-[-1.56px] w-[118px]">Bus 51</p>
    </div>
  );
}
...
function Clock() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Clock">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_3_5804)" id="Clock">
...
function BusTimetables() {
  return (
    <div className="absolute h-[2805px] left-0 top-0 w-[1330px]" data-name="Bus Timetables">
      <Group6 />
    </div>
  );
}
...
export default function BusTmetableAll() {
  return (
    <div className="relative size-full" data-name="BusTmetableAll">
      <Group7 />
    </div>
  );
}